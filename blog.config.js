...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '23f927e60ff580d9b240e25ad6839ff9,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Pandaman', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Web holder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://utsgz.qzz.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'utsgz', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20250979号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20250979', // 备案查询链接，如果用了萌备等备案请在这里填写
  ...
  GREETING_WORDS:
    ...
    'Gaze the Stars,Explore the World',
